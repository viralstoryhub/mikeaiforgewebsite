...
const UpgradeModal: React.FC<UpgradeModalProps> = ({ onClose, utilityName }) => {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 z-50 flex items-center justify-center animate-fade-in-up" style={{ animationDuration: '0.3s' }}>
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-md m-4 p-8 text-center">
        ...
        <h3 className="text-2xl font-bold mt-4">Free Limit Reached</h3>
        <p className="mt-2 text-gray-600 dark:text-gray-400">
          You've used all your free runs for the <strong>{utilityName}</strong> this month.
        </p>
        <p className="mt-4 text-gray-600 dark:text-gray-400">
          Upgrade to a Pro plan to get unlimited access to all utilities, plus advanced features in the Workflow Vault and Content Studio.
        </p>
